   ...
   public  class BE_TBUSUARIO
    {
        ...
        private int m_IDE_TIENDA;
        public int IDE_TIENDA
        {
            get { return m_IDE_TIENDA; }
            set { m_IDE_TIENDA = value; }
        }

        private int m_IDE_SISTEMA;
        public int IDE_SISTEMA
        {
            get { return m_IDE_SISTEMA; }
            set { m_IDE_SISTEMA = value; }
        }
